...
PinkGhost::PinkGhost() : Ghost(380, 380)
{
	this->loadTexture();
...
void PinkGhost::loadTexture() {
	this->ghost_texture.loadFromFile("C:\\Users\\Admin\\Documents\\GitHub\\a87312ac-gr41-repo\\Projekt\\pacman\\images\\pinkghost.png");
}

void PinkGhost::setUpMoveVector()
{
